...
export const ButtonAnimated = forwardRef(function ButtonAnimated(
  {
    color,
    outline,
    animated,
  ...
  return "href" in props ? (
    ...
    >
      {animated ? (
        <AnimatedTouchTarget state={state} loader={loader} success={success}>
          {children}
        </AnimatedTouchTarget>
      ) : (
    ...
    <Headless.Button
      {...props}
      className={clsx(classes, "cursor-default overflow-hidden")}
      ref={ref}
    >
      {animated ? (
        <AnimatedTouchTarget state={state} loader={loader} success={success}>
...
export function AnimatedTouchTarget({
  children,
  state = "idle",
  loader,
  success,
