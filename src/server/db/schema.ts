...
export const nutritionScreeningSchema = createTable("nutrition_screening", {
  ...
  narcoticConsumption: text("narcotic_consumption"),
  hypertension: text("hypertension"),
  hipertensionFamilyMembers: text("hipertension_family_members"),
  hipertensionInFamily: text("hipertension_in_family"),
  bloodGlucose: text("blood_glucose"),
  observationHealth: text("observation_health"),
  haveKids: text("have_kids"),
  kidsHealthyFoodLack: text("kids_healthy_food_lack"),
  kidsReducedFoodIntake: text("kids_reduced_food_intake"),
  kidsLessFood: text("kids_less_food"),
